        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <select
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3.5 pl-12 rounded-xl border-2 transition-all duration-300 outline-none focus:ring-4 appearance-none bg-gray-50 focus:bg-white cursor-pointer hover:border-primary/50 ${
                errors.doctor
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <input
                ...
                value={formData.date}
                onChange={handleChange}
                placeholder={t.form.fields.placeholders.date}
                min={new Date().toISOString().split("T")[0]}
                className={`w-full px-4 py-3.5 pl-12 rounded-xl border-2 transition-all duration-200 outline-none focus:ring-2 bg-gray-50 focus:bg-white cursor-pointer appearance-none ${
                  errors.date
                    ? "border-red-300 focus:ring-red-100 placeholder-red-300"
                    : "border-gray-200 focus:border-primary focus:ring-primary/20 placeholder-gray-700"
                }`}
              />
              <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none transition-transform duration-300 group-focus-within:rotate-180">
                <svg
